    ...
    const [state, submitAction, isPending] = useActionState(
        async(prevState, formData) => {
            ...
            try {
                ...
                return {error: error.response.data.msg || "Failed to resend email"}
            }
        },
        null
    )
  ...
  return (
    <div className='px-2 my-[8%]'>  
        <div className='mx-auto max-w-lg p-5 rounded-xl bg-gradient-to-tl from-slate-900 to-slate-950 shadow'>
            <h1 className='text-white font-bold text-center text-2xl'>Resend Verification Link?</h1>
            <p className='text-slate-400 text-center'>Enter your email that you used to register your account.</p>
